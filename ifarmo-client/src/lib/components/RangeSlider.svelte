<script lang="ts">
    ...
    const mouseEventShield: HTMLDivElement = document.createElement("div");
    ...
    function isMouseInElement(event: MouseEvent, element: HTMLDivElement | null): boolean {
    ...
    function calculateNewValue(clientX: number) {
        ...
        // Limit value min -> max
        setValue(parseInt(String((percent * (max - min)) / 100)) + min);
    }
