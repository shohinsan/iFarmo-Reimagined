...
# ALTER TABLE Products ADD CONSTRAINT farmId FOREIGN KEY (farmId) REFERENCES Farms (farmId) ON DELETE CASCADE;
# ALTER TABLE Products ADD CONSTRAINT userId FOREIGN KEY (userId) REFERENCES Users (userId) ON DELETE CASCADE;
